        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentCars = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buildings_Residences_ResidenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentNumber = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Floor = table.Column<int>(type: "int", nullable: false),
                    Surface = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnnualReports_Users_GeneratedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentComments_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentComments_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatePart1 = table.Column<int>(type: "int", nullable: false),
                    PlatePart2 = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PlatePart3 = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberNotes_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MemberNotes_Users_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberNotes_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyPayments_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MonthlyPayments_Users_RecordedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpensesCount = table.Column<int>(type: "int", nullable: false),
                    ReportFilePath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GeneratedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    GeneratedByUserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyReports_Users_GeneratedById",
                        column: x => x.GeneratedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RevenueDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Title = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Description = table.Column<string>(type: "longtext", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OtherRevenues_Users_RecordedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReceiptFilePath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RecordedById = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ServiceCategory = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Phone = table.Column<string>(type: "longtext", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CallsForFunds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CallsForFunds_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CallsForFunds_Charges_ChargeId",
                        column: x => x.ChargeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallForFundsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_CallsForFunds_CallForFundsId",
                        column: x => x.CallForFundsId,
                        principalTable: "CallsForFunds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VotedOn = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PollVotes_Users_AdherentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 2, 24, 1, 48, 52, 62, DateTimeKind.Utc).AddTicks(1382), "Syndic avec accès complet", "SuperAdmin" },
                    { 2, new DateTime(2026, 2, 24, 1, 48, 52, 62, DateTimeKind.Utc).AddTicks(1392), "Administrateur avec accès limité", "Admin" },
                    { 3, new DateTime(2026, 2, 24, 1, 48, 52, 62, DateTimeKind.Utc).AddTicks(1396), "Résident/Adhérent", "Adherent" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnualReports_GeneratedById",
                table: "AnnualReports",
                column: "GeneratedById");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentComments_ApartmentId",
                table: "ApartmentComments",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentComments_CreatedById",
                table: "ApartmentComments",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_ResidenceId",
                table: "Buildings",
                column: "ResidenceId");

            migrationBuilder.CreateIndex(
                name: "IX_CallsForFunds_ApartmentId_DueDate",
                table: "CallsForFunds",
                columns: new[] { "ApartmentId", "DueDate" });

            migrationBuilder.CreateIndex(
                name: "IX_CallsForFunds_ChargeId",
                table: "CallsForFunds",
                column: "ChargeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_PlatePart1_PlatePart2_PlatePart3",
                table: "Cars",
                columns: new[] { "PlatePart1", "PlatePart2", "PlatePart3" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberNotes_CreatedByUserId",
                table: "MemberNotes",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberNotes_UpdatedByUserId",
                table: "MemberNotes",
                column: "UpdatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyPayments_ApartmentId_Year_Month",
                table: "MonthlyPayments",
                columns: new[] { "ApartmentId", "Year", "Month" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyPayments_RecordedById",
                table: "MonthlyPayments",
                column: "RecordedById");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyReports_GeneratedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtherRevenues_RecordedByUserId",
                table: "OtherRevenues",
                column: "RecordedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OtherRevenues_RevenueDate",
                table: "OtherRevenues",
                column: "RevenueDate");

            migrationBuilder.CreateIndex(
                name: "IX_OtpCodes_UserId_Code_ExpiresAt",
                table: "OtpCodes",
                columns: new[] { "UserId", "Code", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_CallForFundsId",
                table: "PaymentAllocations",
                column: "CallForFundsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ApartmentId_PaymentDate",
                table: "Payments",
                columns: new[] { "ApartmentId", "PaymentDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollVotes_PollId_AdherentId",
                table: "PollVotes",
                columns: new[] { "PollId", "AdherentId" },
                unique: true);
